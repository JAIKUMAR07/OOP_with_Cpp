...
public:
  ...
  customer(string n, int acc_num)
  {
    ...
    balance = 0; // Default balance initialization
  }
  // Overloaded constructor with parameters for name, account number, and balance
...
int main()
{
  ...
  customer c3("aman", 6162);
  c3.display(); // Displaying customer details using the display method
  return 0;
}
